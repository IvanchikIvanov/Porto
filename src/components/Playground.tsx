        ...
        <section ref={containerRef} className="py-32 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <span className="w-3 h-3 bg-cyber-primary rounded-full animate-pulse"></span>
                            <span className="text-cyber-primary font-mono text-sm tracking-widest">{t('playground.badge')}</span>
                        </div>
                        <h2 className="text-4xl md:text-6xl font-bold text-white font-mono leading-none">
                            {t('playground.title_1')} {t('playground.title_2') && <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600">{t('playground.title_2')}</span>}
                        </h2>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <TerminalBox title={t('playground.magnet_title')} borderColor="cyan">
                        <div className="h-48 flex flex-col items-center justify-center gap-6 bg-neutral-900/50 rounded-lg p-4 mb-4">
                            <MagneticButton>
                                <button className="px-8 py-4 bg-white text-black font-bold rounded-full hover:bg-gradient-to-r hover:from-cyan-400 hover:to-purple-600 hover:text-white transition-all">
                        ...
                        <div className="text-xs text-neutral-500 font-mono">
                            <span className="text-cyber-primary">const</span> force = useMotionValue(0);
                        </div>
                    </TerminalBox>
