        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-2 font-mono">
              <p className="text-cyber-green text-sm typing-effect overflow-hidden whitespace-nowrap border-r-2 border-cyber-green w-fit pr-1 animate-pulse">
                root@siteberry:~$ initialize_sequence.sh
              </p>
              <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tighter leading-none">
                <DecodingText text="DIGITAL" startDelay={500} /><br />
                <span className="text-neutral-500">REALITY</span><br />
                {/* We use text-white for scramble here to contrast against the primary text */}
                <DecodingText 
                  text="ARCHITECTS" 
            ...
            <p className="text-neutral-400 max-w-lg text-lg leading-relaxed border-l-2 border-neutral-800 pl-4">
              // We craft high-performance web applications, telegram bots, and digital ecosystems. No fluff, just pure code and aesthetics.
            </p>

            <div className="flex flex-wrap gap-4">
              <a 
                href="#contact" 
                className="group relative inline-flex items-center gap-3 px-8 py-3 bg-cyber-green text-white font-bold font-mono tracking-wider overflow-hidden hover:bg-white hover:text-black transition-colors"
              >
              ...
              <a 
                href="#services" 
                className="inline-flex items-center gap-3 px-8 py-3 border border-neutral-700 text-white font-mono tracking-wider hover:border-cyber-green hover:text-cyber-green transition-all"
              >
            ...
            <div className="pt-8 flex items-center gap-8 text-neutral-600">
               <div className="flex items-center gap-2">
                 ...
                 <span className="text-xs">CLEAN_CODE</span>
               </div>
               <div className="flex items-center gap-2">
          ...
          <div className="hidden lg:block">
            ...
            >
              ...
              <div className="relative bg-cyber-black border border-neutral-800 p-2">
                <div className="flex items-center justify-between px-2 pb-2 border-b border-neutral-800 mb-2">
